...
function CopyToast({ show }: { show: boolean }) {
  if (!show) return null;
  return (
    <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-gray-800 text-white text-[11px] px-2.5 py-1 rounded-lg whitespace-nowrap copy-toast pointer-events-none">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={`flex items-center gap-1 mt-3 transition-all duration-200 ${showActions || !isUser ? 'opacity-100' : 'opacity-60'}`}>
          {!isUser && (
            <>
              <button className="p-1.5 rounded-full hover:bg-gray-100 transition-all duration-150 hover-scale" title="Tetszik">
              ...
              <button className="p-1.5 rounded-full hover:bg-gray-100 transition-all duration-150 hover-scale" title="Nem tetszik">
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="p-1.5 rounded-full hover:bg-gray-100 transition-all duration-150 hover-scale"
                title="Újragenerálás"
              >
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
