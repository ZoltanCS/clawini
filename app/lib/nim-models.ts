...
const NIM_CATALOG: NimModel[] = [
  { id: 'arn:aws:bedrock:us-east-1:936854375954:inference-profile/us.amazon.nova-lite-v1:0', label: 'Nova 2 Lite',      publisher: 'Amazon',      contextWindow: 300000, supportsVision: true, supportsThinking: true, tier: 'normal', description: 'Multimodális, gyors, olcsó' },
...
export const DEFAULT_NIM_MODEL_ID = 'arn:aws:bedrock:us-east-1:936854375954:inference-profile/us.amazon.nova-lite-v1:0';
